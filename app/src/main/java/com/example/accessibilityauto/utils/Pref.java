...
import com.example.accessibilityauto.service.AccessibilityConfig;
...
public class Pref {
    ...
    private static final SharedPreferences DISPOSABLE_BOOLEAN = App.Companion.getApp().getSharedPreferences("DISPOSABLE_BOOLEAN",Context.MODE_PRIVATE);
    ...
    private static final SharedPreferences.OnSharedPreferenceChangeListener onSharedPreferenceChangeListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
        ...
        public void onSharedPreferenceChanged(SharedPreferences p, String key) {
                AccessibilityConfig.setIsUnintendedGuardEnabled( false);

        }
    };

    static {
        AccessibilityConfig.setIsUnintendedGuardEnabled(def().getBoolean("OK",false));
    }

    private static SharedPreferences def() {
        return PreferenceManager.getDefaultSharedPreferences(App.Companion.getApp());
    }
...
//    }
    ...
    private static String getString(int id) {
        return App.Companion.getApp().getString(id);
    }
